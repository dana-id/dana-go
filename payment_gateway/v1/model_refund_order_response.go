...
func (o *RefundOrderResponse) SetOriginalReferenceNo(v string) error {
...
func (o *RefundOrderResponse) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *RefundOrderResponse) SetOriginalCaptureNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
...
func (o *RefundOrderResponse) SetRefundNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for RefundNo, must be smaller than or equal to 64")
		}
	}
	o.RefundNo = &v
	return nil
...
func (o *RefundOrderResponse) SetRefundTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for RefundTime, must be smaller than or equal to 25")
		}
	}
	o.RefundTime = &v
	return nil
