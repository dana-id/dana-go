...
func (o *PayOptionDetail) SetCardToken(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for CardToken, must be smaller than or equal to 64")
		}
	}
	o.CardToken = &v
	return nil
...
func (o *PayOptionDetail) SetMerchantToken(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for MerchantToken, must be smaller than or equal to 64")
		}
	}
	o.MerchantToken = &v
	return nil
