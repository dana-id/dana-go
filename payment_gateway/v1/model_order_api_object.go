...
func (o *OrderApiObject) SetMerchantTransType(v string) error {
...
func (o *OrderApiObject) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *OrderApiObject) SetScenario(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
