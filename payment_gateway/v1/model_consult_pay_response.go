...
func (o *ConsultPayResponse) SetResponseCode(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 7 {
			return fmt.Errorf("invalid length for ResponseCode, must be smaller than or equal to 7")
		}
	}
	o.ResponseCode = &v
	return nil
...
func (o *ConsultPayResponse) SetResponseMessage(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 150 {
			return fmt.Errorf("invalid length for ResponseMessage, must be smaller than or equal to 150")
		}
	}
	o.ResponseMessage = &v
	return nil
