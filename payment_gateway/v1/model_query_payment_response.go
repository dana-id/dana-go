...
func (o *QueryPaymentResponse) SetOriginalPartnerReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for OriginalPartnerReferenceNo, must be smaller than or equal to 64")
		}
	}
...
func (o *QueryPaymentResponse) SetOriginalReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for OriginalReferenceNo, must be smaller than or equal to 64")
		}
	}
...
func (o *QueryPaymentResponse) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for OriginalExternalId, must be smaller than or equal to 32")
		}
	}
...
func (o *QueryPaymentResponse) SetTransactionStatusDesc(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 50 {
			return fmt.Errorf("invalid length for TransactionStatusDesc, must be smaller than or equal to 50")
		}
	}
...
func (o *QueryPaymentResponse) SetOriginalResponseCode(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 7 {
			return fmt.Errorf("invalid length for OriginalResponseCode, must be smaller than or equal to 7")
		}
	}
...
func (o *QueryPaymentResponse) SetOriginalResponseMessage(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 150 {
			return fmt.Errorf("invalid length for OriginalResponseMessage, must be smaller than or equal to 150")
		}
	}
...
func (o *QueryPaymentResponse) SetSessionId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for SessionId, must be smaller than or equal to 25")
		}
	}
	o.SessionId = &v
	return nil
...
func (o *QueryPaymentResponse) SetRequestID(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for RequestID, must be smaller than or equal to 25")
		}
	}
	o.RequestID = &v
	return nil
...
func (o *QueryPaymentResponse) SetPaidTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
...
func (o *QueryPaymentResponse) SetTitle(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 256 {
			return fmt.Errorf("invalid length for Title, must be smaller than or equal to 256")
		}
	}
	o.Title = &v
	return nil
