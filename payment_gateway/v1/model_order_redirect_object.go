...
func (o *OrderRedirectObject) SetMerchantTransType(v string) error {
...
func (o *OrderRedirectObject) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *OrderRedirectObject) SetScenario(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for Scenario, must be smaller than or equal to 64")
		}
	}
	o.Scenario = &v
	return nil
