...
func (o *ConsultPayRequestAdditionalInfo) SetMerchantTransType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for MerchantTransType, must be smaller than or equal to 64")
		}
	}
