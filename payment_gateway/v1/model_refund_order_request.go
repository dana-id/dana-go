...
func (o *RefundOrderRequest) SetSubMerchantId(v string) error {
...
func (o *RefundOrderRequest) SetOriginalReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *RefundOrderRequest) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *RefundOrderRequest) SetOriginalCaptureNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for OriginalCaptureNo, must be smaller than or equal to 64")
		}
	}
...
func (o *RefundOrderRequest) SetExternalStoreId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
...
func (o *RefundOrderRequest) SetReason(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 256 {
			return fmt.Errorf("invalid length for Reason, must be smaller than or equal to 256")
		}
	}
	o.Reason = &v
	return nil
