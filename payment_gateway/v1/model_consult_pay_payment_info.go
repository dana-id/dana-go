...
func (o *ConsultPayPaymentInfo) SetPayOption(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 128 {
			return fmt.Errorf("invalid length for PayOption, must be smaller than or equal to 128")
		}
	}
	o.PayOption = &v
	return nil
