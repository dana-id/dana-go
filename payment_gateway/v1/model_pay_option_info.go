...
func (o *PayOptionInfo) SetPayOption(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PayOption, must be smaller than or equal to 64")
		}
	}
	o.PayOption = &v
	return nil
...
func (o *PayOptionInfo) SetPayOptionBillExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4096 {
			return fmt.Errorf("invalid length for PayOptionBillExtendInfo, must be smaller than or equal to 4096")
		}
	}
...
func (o *PayOptionInfo) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4096 {
