...
func (o *CreateOrderByRedirectRequest) SetSubMerchantId(v string) error {
...
func (o *CreateOrderByRedirectRequest) SetExternalStoreId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *CreateOrderByRedirectRequest) SetValidUpTo(v string) error {
...
func (o *CreateOrderByRedirectRequest) SetDisabledPayMethods(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
