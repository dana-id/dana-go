...
func (o *VirtualAccountInfo) SetVirtualAccountCode(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for VirtualAccountCode, must be smaller than or equal to 64")
		}
	}
...
func (o *VirtualAccountInfo) SetVirtualAccountExpiryTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for VirtualAccountExpiryTime, must be smaller than or equal to 25")
		}
	}
...
func (o *VirtualAccountInfo) SetSignature(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 128 {
			return fmt.Errorf("invalid length for Signature, must be smaller than or equal to 128")
		}
	}
	o.Signature = &v
	return nil
