...
func (o *Goods) SetUnit(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for Unit, must be smaller than or equal to 64")
		}
	}
	o.Unit = &v
	return nil
...
func (o *Goods) SetMerchantShippingId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for MerchantShippingId, must be smaller than or equal to 64")
		}
	}
...
func (o *Goods) SetSnapshotUrl(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 512 {
			return fmt.Errorf("invalid length for SnapshotUrl, must be smaller than or equal to 512")
		}
	}
	o.SnapshotUrl = &v
	return nil
...
func (o *Goods) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
