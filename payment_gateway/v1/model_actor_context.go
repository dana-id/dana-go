...
func (o *ActorContext) SetActorId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for ActorId, must be smaller than or equal to 64")
		}
	}
	o.ActorId = &v
	return nil
...
func (o *ActorContext) SetActorType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for ActorType, must be smaller than or equal to 32")
		}
	}
	o.ActorType = &v
	return nil
