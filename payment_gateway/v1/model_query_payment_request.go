...
func (o *QueryPaymentRequest) SetOriginalPartnerReferenceNo(v string) error {
...
func (o *QueryPaymentRequest) SetOriginalReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
...
func (o *QueryPaymentRequest) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 36 {
			return fmt.Errorf("invalid length for OriginalExternalId, must be smaller than or equal to 36")
		}
	}
...
func (o *QueryPaymentRequest) SetTransactionDate(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for TransactionDate, must be smaller than or equal to 25")
		}
	}
	o.TransactionDate = &v
	return nil
...
func (o *QueryPaymentRequest) SetSubMerchantId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *QueryPaymentRequest) SetExternalStoreId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
