...
func (o *AuditInfo) SetActionReason(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 256 {
			return fmt.Errorf("invalid length for ActionReason, must be smaller than or equal to 256")
		}
	}
	o.ActionReason = &v
	return nil
...
func (o *AuditInfo) SetThirdClientId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for ThirdClientId, must be smaller than or equal to 32")
		}
	}
	o.ThirdClientId = &v
	return nil
