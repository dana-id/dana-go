...
*/
func (a *DisbursementAPIService) QueryMerchantResource(ctx context.Context) ApiQueryMerchantResourceRequest {
	return ApiQueryMerchantResourceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DisbursementAPIService) QueryMerchantResourceExecute(r ApiQueryMerchantResourceRequest) (*QueryMerchantResourceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []common.FormFile
	...
	localBasePath, err := a.GetConfig().ServerURLWithContext(r.ctx, "DisbursementAPIService.QueryMerchantResource")
	if err != nil {
		return localVarReturnValue, nil, &exceptions.GenericOpenAPIError{
			ErrorMsg: err.Error(),
		}
	...
	localVarPath := localBasePath + "/merchant/queryMerchantResource.htm"
