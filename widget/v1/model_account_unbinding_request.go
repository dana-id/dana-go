...
func (o *AccountUnbindingRequest) SetSubMerchantId(v string) error {
...
func (o *AccountUnbindingRequest) SetPartnerReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *AccountUnbindingRequest) SetLinkId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *AccountUnbindingRequest) SetTokenId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 128 {
			return fmt.Errorf("invalid length for TokenId, must be smaller than or equal to 128")
		}
	}
	o.TokenId = &v
	return nil
