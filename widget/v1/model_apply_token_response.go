...
func (o *ApplyTokenResponse) SetTokenType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 7 {
			return fmt.Errorf("invalid length for TokenType, must be smaller than or equal to 7")
		}
	}
	o.TokenType = &v
	return nil
...
func (o *ApplyTokenResponse) SetAccessTokenExpiryTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for AccessTokenExpiryTime, must be smaller than or equal to 25")
		}
	}
...
func (o *ApplyTokenResponse) SetRefreshToken(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *ApplyTokenResponse) SetRefreshTokenExpiryTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for RefreshTokenExpiryTime, must be smaller than or equal to 25")
		}
	}
