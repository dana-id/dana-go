...
func (o *CancelOrderResponse) SetOriginalReferenceNo(v string) error {
...
func (o *CancelOrderResponse) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *CancelOrderResponse) SetCancelTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for CancelTime, must be smaller than or equal to 25")
		}
	}
	o.CancelTime = &v
	return nil
...
func (o *CancelOrderResponse) SetTransactionDate(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
