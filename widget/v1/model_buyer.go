...
func (o *Buyer) SetExternalUserType(v string) error {
...
func (o *Buyer) SetNickname(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *Buyer) SetExternalUserId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
...
func (o *Buyer) SetUserId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
