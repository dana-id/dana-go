...
func NewWidgetPaymentRequest(partnerReferenceNo string, merchantId string, amount Money, validUpTo string, additionalInfo WidgetPaymentRequestAdditionalInfo) *WidgetPaymentRequest {
...
func (o *WidgetPaymentRequest) SetSubMerchantId(v string) error {
...
func (o *WidgetPaymentRequest) SetExternalStoreId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *WidgetPaymentRequest) SetPointOfInitiation(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 20 {
			return fmt.Errorf("invalid length for PointOfInitiation, must be smaller than or equal to 20")
		}
	}
...
func (o *WidgetPaymentRequest) SetDisabledPayMethods(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
