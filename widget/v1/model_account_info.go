...
func (o *AccountInfo) SetBalanceType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 70 {
			return fmt.Errorf("invalid length for BalanceType, must be smaller than or equal to 70")
		}
	}
	o.BalanceType = &v
	return nil
...
func (o *AccountInfo) SetRegistrationStatusCode(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4 {
			return fmt.Errorf("invalid length for RegistrationStatusCode, must be smaller than or equal to 4")
		}
	}
...
func (o *AccountInfo) SetStatus(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4 {
			return fmt.Errorf("invalid length for Status, must be smaller than or equal to 4")
		}
	}
	o.Status = &v
	return nil
