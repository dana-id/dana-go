...
func (o *Seller) SetExternalUserType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for ExternalUserType, must be smaller than or equal to 32")
		}
	}
...
func (o *Seller) SetNickname(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for Nickname, must be smaller than or equal to 64")
		}
	}
	o.Nickname = &v
	return nil
...
func (o *Seller) SetExternalUserId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for ExternalUserId, must be smaller than or equal to 32")
		}
	}
	o.ExternalUserId = &v
	return nil
...
func (o *Seller) SetUserId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 32 {
			return fmt.Errorf("invalid length for UserId, must be smaller than or equal to 32")
		}
	}
	o.UserId = &v
	return nil
