...
func (o *PayOptionDetailAdditionalInfo) SetPayerAccountNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PayerAccountNo, must be smaller than or equal to 64")
		}
	}
	o.PayerAccountNo = &v
	return nil
...
func (o *PayOptionDetailAdditionalInfo) SetChannelInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4096 {
			return fmt.Errorf("invalid length for ChannelInfo, must be smaller than or equal to 4096")
		}
	}
	o.ChannelInfo = &v
	return nil
...
func (o *PayOptionDetailAdditionalInfo) SetIssuingCountry(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 8 {
			return fmt.Errorf("invalid length for IssuingCountry, must be smaller than or equal to 8")
		}
	}
	o.IssuingCountry = &v
	return nil
...
func (o *PayOptionDetailAdditionalInfo) SetAssetType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for AssetType, must be smaller than or equal to 64")
		}
	}
	o.AssetType = &v
	return nil
...
func (o *PayOptionDetailAdditionalInfo) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 4096 {
