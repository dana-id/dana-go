...
func (o *BalanceInquiryResponse) SetReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for ReferenceNo, must be smaller than or equal to 64")
		}
	}
	o.ReferenceNo = &v
	return nil
...
func (o *BalanceInquiryResponse) SetPartnerReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PartnerReferenceNo, must be smaller than or equal to 64")
		}
	}
...
func (o *BalanceInquiryResponse) SetName(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 140 {
			return fmt.Errorf("invalid length for Name, must be smaller than or equal to 140")
		}
	}
	o.Name = &v
	return nil
