...
func (o *Order) SetMerchantTransType(v string) error {
...
func (o *Order) SetOrderMemo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for OrderMemo, must be smaller than or equal to 64")
		}
	}
	o.OrderMemo = &v
	return nil
...
func (o *Order) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
