...
type _RefundOrderRequestAdditionalInfo RefundOrderRequestAdditionalInfo
...
func (o *RefundOrderRequestAdditionalInfo) SetPayoutAccountNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PayoutAccountNo, must be smaller than or equal to 64")
		}
	}
	o.PayoutAccountNo = &v
	return nil
...
func (o *RefundOrderRequestAdditionalInfo) SetRefundAppliedTime(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 25 {
			return fmt.Errorf("invalid length for RefundAppliedTime, must be smaller than or equal to 25")
		}
	}
...
func (o *RefundOrderRequestAdditionalInfo) SetActorType(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for ActorType, must be smaller than or equal to 64")
		}
	}
	o.ActorType = &v
	return nil
...
func (o *RefundOrderRequestAdditionalInfo) SetReturnChargeToPayer(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for ReturnChargeToPayer, must be smaller than or equal to 64")
		}
	}
...
func (o *RefundOrderRequestAdditionalInfo) SetDestination(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for Destination, must be smaller than or equal to 64")
		}
	}
	o.Destination = &v
	return nil
...
func (o *RefundOrderRequestAdditionalInfo) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *RefundOrderRequestAdditionalInfo) SetAsyncRefund(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 5 {
			return fmt.Errorf("invalid length for AsyncRefund, must be smaller than or equal to 5")
		}
	}
	o.AsyncRefund = &v
	return nil
...
func (o *RefundOrderRequestAdditionalInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varRefundOrderRequestAdditionalInfo := _RefundOrderRequestAdditionalInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRefundOrderRequestAdditionalInfo)

	if err != nil {
		return err
	}

	*o = RefundOrderRequestAdditionalInfo(varRefundOrderRequestAdditionalInfo)
