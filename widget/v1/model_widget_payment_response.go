...
// checks if the WidgetPaymentResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WidgetPaymentResponse{}

// WidgetPaymentResponse Response object for Direct Debit Payment API
type WidgetPaymentResponse struct {
...
type _WidgetPaymentResponse WidgetPaymentResponse
...
func (o *WidgetPaymentResponse) SetReferenceNo(v string) error {
...
func (o *WidgetPaymentResponse) SetWebRedirectUrl(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 2048 {
			return fmt.Errorf("invalid length for WebRedirectUrl, must be smaller than or equal to 2048")
		}
	}
	o.WebRedirectUrl = &v
	return nil
...
func (o WidgetPaymentResponse) MarshalJSON() ([]byte, error) {
...
func (o WidgetPaymentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WidgetPaymentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWidgetPaymentResponse := _WidgetPaymentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWidgetPaymentResponse)

	if err != nil {
		return err
	}

	*o = WidgetPaymentResponse(varWidgetPaymentResponse)

	return err
}

type NullableWidgetPaymentResponse struct {
	value *WidgetPaymentResponse
	isSet bool
}

func (v NullableWidgetPaymentResponse) Get() *WidgetPaymentResponse {
	return v.value
}

func (v *NullableWidgetPaymentResponse) Set(val *WidgetPaymentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWidgetPaymentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWidgetPaymentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWidgetPaymentResponse(val *WidgetPaymentResponse) *NullableWidgetPaymentResponse {
	return &NullableWidgetPaymentResponse{value: val, isSet: true}
}

func (v NullableWidgetPaymentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWidgetPaymentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
