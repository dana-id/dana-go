...
func (o *AccountUnbindingResponse) SetReferenceNo(v string) error {
...
func (o *AccountUnbindingResponse) SetPartnerReferenceNo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
...
func (o *AccountUnbindingResponse) SetMerchantId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for MerchantId, must be smaller than or equal to 64")
		}
	}
	o.MerchantId = &v
	return nil
...
func (o *AccountUnbindingResponse) SetSubMerchantId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *AccountUnbindingResponse) SetLinkId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 24 {
			return fmt.Errorf("invalid length for LinkId, must be smaller than or equal to 24")
		}
	}
	o.LinkId = &v
	return nil
...
func (o *AccountUnbindingResponse) SetUnlinkResult(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for UnlinkResult, must be smaller than or equal to 64")
		}
	}
	o.UnlinkResult = &v
	return nil
