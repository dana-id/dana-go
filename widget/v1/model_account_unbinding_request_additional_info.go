...
// checks if the AccountUnbindingRequestAdditionalInfo type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AccountUnbindingRequestAdditionalInfo{}

// AccountUnbindingRequestAdditionalInfo struct for AccountUnbindingRequestAdditionalInfo
type AccountUnbindingRequestAdditionalInfo struct {
...
type _AccountUnbindingRequestAdditionalInfo AccountUnbindingRequestAdditionalInfo
...
func NewAccountUnbindingRequestAdditionalInfo(accessToken string, deviceId string) *AccountUnbindingRequestAdditionalInfo {
	this := AccountUnbindingRequestAdditionalInfo{}
...
func (o *AccountUnbindingRequestAdditionalInfo) SetEndUserIpAddress(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 15 {
			return fmt.Errorf("invalid length for EndUserIpAddress, must be smaller than or equal to 15")
		}
	}
...
func (o *AccountUnbindingRequestAdditionalInfo) SetLatitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 10 {
			return fmt.Errorf("invalid length for Latitude, must be smaller than or equal to 10")
		}
	}
	o.Latitude = &v
	return nil
...
func (o *AccountUnbindingRequestAdditionalInfo) SetLongitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 10 {
			return fmt.Errorf("invalid length for Longitude, must be smaller than or equal to 10")
		}
	}
	o.Longitude = &v
	return nil
...
func (o AccountUnbindingRequestAdditionalInfo) MarshalJSON() ([]byte, error) {
...
func (o AccountUnbindingRequestAdditionalInfo) ToMap() (map[string]interface{}, error) {
...
func (o *AccountUnbindingRequestAdditionalInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountUnbindingRequestAdditionalInfo := _AccountUnbindingRequestAdditionalInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountUnbindingRequestAdditionalInfo)

	if err != nil {
		return err
	}

	*o = AccountUnbindingRequestAdditionalInfo(varAccountUnbindingRequestAdditionalInfo)

	return err
}

type NullableAccountUnbindingRequestAdditionalInfo struct {
	value *AccountUnbindingRequestAdditionalInfo
	isSet bool
}

func (v NullableAccountUnbindingRequestAdditionalInfo) Get() *AccountUnbindingRequestAdditionalInfo {
	return v.value
}

func (v *NullableAccountUnbindingRequestAdditionalInfo) Set(val *AccountUnbindingRequestAdditionalInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountUnbindingRequestAdditionalInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountUnbindingRequestAdditionalInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountUnbindingRequestAdditionalInfo(val *AccountUnbindingRequestAdditionalInfo) *NullableAccountUnbindingRequestAdditionalInfo {
	return &NullableAccountUnbindingRequestAdditionalInfo{value: val, isSet: true}
}

func (v NullableAccountUnbindingRequestAdditionalInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountUnbindingRequestAdditionalInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
