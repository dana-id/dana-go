...
func (o *QueryPaymentResponseAdditionalInfo) SetMerchantId(v string) error {
...
func (o *QueryPaymentResponseAdditionalInfo) SetOrderMemo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
...
func (o *QueryPaymentResponseAdditionalInfo) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *QueryPaymentResponseAdditionalInfo) SetCloseReason(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 128 {
			return fmt.Errorf("invalid length for CloseReason, must be smaller than or equal to 128")
		}
	}
	o.CloseReason = &v
	return nil
