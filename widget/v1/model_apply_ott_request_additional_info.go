...
func (o *ApplyOTTRequestAdditionalInfo) SetEndUserIpAddress(v string) error {
...
func (o *ApplyOTTRequestAdditionalInfo) SetLatitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *ApplyOTTRequestAdditionalInfo) SetLongitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 10 {
