...
func (o *CancelOrderRequest) SetOriginalReferenceNo(v string) error {
...
func (o *CancelOrderRequest) SetOriginalExternalId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *CancelOrderRequest) SetSubMerchantId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *CancelOrderRequest) SetReason(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *CancelOrderRequest) SetExternalStoreId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
