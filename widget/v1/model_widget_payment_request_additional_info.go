...
func (o *WidgetPaymentRequestAdditionalInfo) SetSupportDeepLinkCheckoutUrl(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for SupportDeepLinkCheckoutUrl, must be smaller than or equal to 64")
		}
	}
...
func (o *WidgetPaymentRequestAdditionalInfo) SetPhoneNumber(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PhoneNumber, must be smaller than or equal to 64")
		}
	}
	o.PhoneNumber = &v
	return nil
...
func (o *WidgetPaymentRequestAdditionalInfo) SetPublicUserId(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 64 {
			return fmt.Errorf("invalid length for PublicUserId, must be smaller than or equal to 64")
		}
	}
	o.PublicUserId = &v
	return nil
...
func (o *WidgetPaymentRequestAdditionalInfo) SetExtendInfo(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
