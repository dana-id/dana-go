...
func (o *BalanceInquiryRequestAdditionalInfo) SetEndUserIpAddress(v string) error {
...
func (o *BalanceInquiryRequestAdditionalInfo) SetLatitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
...
func (o *BalanceInquiryRequestAdditionalInfo) SetLongitude(v string) error {
	// Validate string length constraints
	if !utils.IsNil(v) {
		if utils.Strlen(v) > 10 {
