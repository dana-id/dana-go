...
// checks if the QueryDivisionResponseResponseHead type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &QueryDivisionResponseResponseHead{}

// QueryDivisionResponseResponseHead struct for QueryDivisionResponseResponseHead
type QueryDivisionResponseResponseHead struct {
	// API version
...
func NewQueryDivisionResponseResponseHead() *QueryDivisionResponseResponseHead {
	this := QueryDivisionResponseResponseHead{}
...
func (o QueryDivisionResponseResponseHead) MarshalJSON() ([]byte, error) {
...
func (o QueryDivisionResponseResponseHead) ToMap() (map[string]interface{}, error) {
...
type NullableQueryDivisionResponseResponseHead struct {
	value *QueryDivisionResponseResponseHead
	isSet bool
}

func (v NullableQueryDivisionResponseResponseHead) Get() *QueryDivisionResponseResponseHead {
	return v.value
}

func (v *NullableQueryDivisionResponseResponseHead) Set(val *QueryDivisionResponseResponseHead) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryDivisionResponseResponseHead) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryDivisionResponseResponseHead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryDivisionResponseResponseHead(val *QueryDivisionResponseResponseHead) *NullableQueryDivisionResponseResponseHead {
	return &NullableQueryDivisionResponseResponseHead{value: val, isSet: true}
}

func (v NullableQueryDivisionResponseResponseHead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryDivisionResponseResponseHead) UnmarshalJSON(src []byte) error {
	v.isSet = true
