...
// checks if the UpdateShopResponseResponseHead type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &UpdateShopResponseResponseHead{}

// UpdateShopResponseResponseHead struct for UpdateShopResponseResponseHead
type UpdateShopResponseResponseHead struct {
	// API version
...
func NewUpdateShopResponseResponseHead() *UpdateShopResponseResponseHead {
	this := UpdateShopResponseResponseHead{}
...
func (o UpdateShopResponseResponseHead) MarshalJSON() ([]byte, error) {
...
func (o UpdateShopResponseResponseHead) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateShopResponseResponseHead struct {
	value *UpdateShopResponseResponseHead
	isSet bool
}

func (v NullableUpdateShopResponseResponseHead) Get() *UpdateShopResponseResponseHead {
	return v.value
}

func (v *NullableUpdateShopResponseResponseHead) Set(val *UpdateShopResponseResponseHead) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateShopResponseResponseHead) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateShopResponseResponseHead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateShopResponseResponseHead(val *UpdateShopResponseResponseHead) *NullableUpdateShopResponseResponseHead {
	return &NullableUpdateShopResponseResponseHead{value: val, isSet: true}
}

func (v NullableUpdateShopResponseResponseHead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateShopResponseResponseHead) UnmarshalJSON(src []byte) error {
	v.isSet = true
