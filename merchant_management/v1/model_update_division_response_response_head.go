...
// checks if the UpdateDivisionResponseResponseHead type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &UpdateDivisionResponseResponseHead{}

// UpdateDivisionResponseResponseHead struct for UpdateDivisionResponseResponseHead
type UpdateDivisionResponseResponseHead struct {
	// API version
...
func NewUpdateDivisionResponseResponseHead() *UpdateDivisionResponseResponseHead {
	this := UpdateDivisionResponseResponseHead{}
...
func (o UpdateDivisionResponseResponseHead) MarshalJSON() ([]byte, error) {
...
func (o UpdateDivisionResponseResponseHead) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateDivisionResponseResponseHead struct {
	value *UpdateDivisionResponseResponseHead
	isSet bool
}

func (v NullableUpdateDivisionResponseResponseHead) Get() *UpdateDivisionResponseResponseHead {
	return v.value
}

func (v *NullableUpdateDivisionResponseResponseHead) Set(val *UpdateDivisionResponseResponseHead) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDivisionResponseResponseHead) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDivisionResponseResponseHead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDivisionResponseResponseHead(val *UpdateDivisionResponseResponseHead) *NullableUpdateDivisionResponseResponseHead {
	return &NullableUpdateDivisionResponseResponseHead{value: val, isSet: true}
}

func (v NullableUpdateDivisionResponseResponseHead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDivisionResponseResponseHead) UnmarshalJSON(src []byte) error {
	v.isSet = true
