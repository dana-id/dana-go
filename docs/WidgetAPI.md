...
| `RESOURCETYPE_LOGIN_ID_` |  |
| `RESOURCETYPE_CLEAR_TEXT_DANA_ID_` |  |
| `RESOURCETYPE_NICKNAME_` |  |
| `RESOURCETYPE_FULLNAME_` |  |
| `RESOURCETYPE_KTP_NUMBER_` |  |
| `RESOURCETYPE_KTP_PHOTO_DATA_` |  |
| `RESOURCETYPE_SELFIE_PHOTO_DATA_` |  |
| `RESOURCETYPE_AVATAR_URL_` |  |
| `RESOURCETYPE_MASKED_FULLNAME_` |  |
